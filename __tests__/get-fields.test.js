import getFields from '../functions/get-fields/1.0';
describe('Test Get Fields function', () => {
  const params = {
  ...
  test('Run Get Fields with a params object as input', async () => {
    const { as } = await getFields({ params });
